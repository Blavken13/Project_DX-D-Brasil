...
public partial class Player
{
    private void RegisterPetSaveHandlers()
    {
        ...
        // Não misturar os presentes customizados do servidor com o inventário do tutorial original.
        // Como ClaimedGifts continua vazio, eles serão entregues normalmente após sair de Ancora.
        if (RegionCatalog.GetTemplate(_world.TerrainInfo.region_template)?.Role != Shared.Region.Role.Tutorial)
        {
            GrantPendingGifts();
        }
    }
