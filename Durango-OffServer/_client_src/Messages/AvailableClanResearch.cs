...
public struct AvailableClanResearch
{
	...
	public static AvailableClanResearch Unpack(Unpacker unpacker)
	{
		...
		AvailableClanResearch result = new AvailableClanResearch
		{
			AvailableResearchIds = new string[num]
		};
		for (int i = 0; i < num; i++)
		{
			unpacker.Read();
	...
	public override string ToString()
	{
		...
		object[] args = availableResearchIds;
		return string.Format("<AvailableClanResearch AvailableResearchIds={0}>", args);
	}
}
