...
public struct GetDiscoveryRates
{
	...
	public static GetDiscoveryRates Unpack(Unpacker unpacker)
	{
		...
		GetDiscoveryRates result = new GetDiscoveryRates
		{
			TemplateIds = new string[num]
		};
		for (int i = 0; i < num; i++)
		{
			unpacker.Read();
	...
	public override string ToString()
	{
		...
		object[] args = templateIds;
		return string.Format("<GetDiscoveryRates TemplateIds={0}>", args);
	}
}
