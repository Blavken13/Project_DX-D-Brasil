...
public struct FollowTutorialColleagues
{
	...
	public static FollowTutorialColleagues Unpack(Unpacker unpacker)
	{
		...
		FollowTutorialColleagues result = new FollowTutorialColleagues
		{
			Colleagues = new string[num]
		};
		for (int i = 0; i < num; i++)
		{
			unpacker.Read();
	...
	public override string ToString()
	{
		...
		object[] args = colleagues;
		return string.Format("<FollowTutorialColleagues Colleagues={0}>", args);
	}
}
