...
public static class Noise
{
	...
	public static float perlin(float x, float y, float z)
	{
		...
		float num19 = num18;
		float num20 = num13;
		float num21 = num19 + num20 * ((num17 & 0xF) switch
		{
			0 => num4 + num5, 
			1 => 0f - num4 + num5, 
			2 => num4 - num5, 
		...
		byte num22 = perm[num + perm[num11 + perm[num12]]];
		float num23 = num16;
		float num24 = num23;
		num20 = num13;
		float num25 = num24 + num20 * ((num22 & 0xF) switch
		{
			0 => num4 + num8, 
			1 => 0f - num4 + num8, 
			2 => num4 - num8, 
		...
		float num26 = num21 + num14 * (num25 - num21);
		...
		byte num27 = perm[num10 + perm[num2 + perm[num12]]];
		num18 = num16;
		num19 = num18;
		num20 = num13;
		num21 = num19 + num20 * ((num27 & 0xF) switch
		{
			0 => num7 + num5, 
			1 => 0f - num7 + num5, 
			2 => num7 - num5, 
		...
		byte num28 = perm[num10 + perm[num11 + perm[num12]]];
		num23 = num16;
		num24 = num23;
		num20 = num13;
		num25 = num24 + num20 * ((num28 & 0xF) switch
		{
			0 => num7 + num8, 
			1 => 0f - num7 + num8, 
			2 => num7 - num8, 
		...
		float num29 = num21 + num14 * (num25 - num21);
		return 0.936f * (num26 + num15 * (num29 - num26));
	}
