...
public class InputSystem : GameSystem<InputSystem>
{
	...
	public void TestBridgeDispatch(InputCommand inputCommand, Trigger trigger)
	{
		InputCommandMessage inputCommandMessage = new InputCommandMessage();
		inputCommandMessage.Init(inputCommand);
		inputCommandMessage.CurrentTrigger = trigger;
