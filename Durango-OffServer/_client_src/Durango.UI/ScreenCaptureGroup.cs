...
public class ScreenCaptureGroup : UIBase
{
	...
	[SerializeField]
	private Durango.Render.Screen.ScreenCapture.EffectEnum _defaultEffects;

	private Durango.Render.Screen.ScreenCapture.EffectEnum _effect;
	...
	public void ToggleScreenEffect(Durango.Render.Screen.ScreenCapture.EffectEnum effect, bool on)
	{
		if (on)
		{
			_effect |= effect;
	...
	private void RequestCaptureScreenPermissionResult(bool granted)
	{
		...
		{
			OnPreScreenCapture();
			Durango.Render.Screen.ScreenCapture.Capture(new Durango.Render.Screen.ScreenCapture.CaptureOption
			{
				Effect = _effect,
				Logo = true,
				NoUI = true,
