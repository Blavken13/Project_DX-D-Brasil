...
public abstract class ChattingGroupBase : UIBase
{
	...
	{
		UIManager.FindScript<PlayerSearchGroup>().OpenForMultiple(0, disabledList: NewRoomParams.Conversation?.GetEntityIds(), title: T._("대화 상대선택"), callback: OnSelectedPlayers, confirmText: T._("초대"));
	}
