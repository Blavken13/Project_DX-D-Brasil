...
public class InteractionMenuListWidget : InteractionMenuListWidgetBase
{
	...
	private void RepositionMenuMultipleLines(float radius, int eraseWidth)
	{
		...
		for (int visibleCountPerPage = base.VisibleCountPerPage; i < visibleCountPerPage; i++)
		{
			...
			if (num4 != -1)
			{
				float num5 = ((Menus[num4].Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
			...
			if (num4 != -1)
			{
				float num7 = ((Menus[num4].Type != MenuType.Normal) ? InteractionMenuListWidgetBase.MinorScale : InteractionMenuListWidgetBase.MajorScale);
