...
public static class MusicsExtension
{
	...
	public static IEnumerable<KeyValuePair<MusicId, Music>> GetMyMusics(this Musics msg)
	{
		...
		foreach (KeyValuePair<int, Music> music in msg._Musics)
		{
			yield return new KeyValuePair<MusicId, Music>(music.Key, music.Value);
		}
	}
	...
	public static IEnumerable<KeyValuePair<MusicId, Music>> GetSharedMusics(this Musics msg)
	{
		...
		foreach (KeyValuePair<string, Music> sharedMusic in msg.SharedMusics)
		{
			yield return new KeyValuePair<MusicId, Music>(sharedMusic.Key, sharedMusic.Value);
		}
	}
}
