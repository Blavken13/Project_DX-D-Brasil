...
public static class Util
{
	...
	public static IEnumerable<Pair<string, int>> GetStatusEffects(this ItemData item)
	{
		...
		{
			if (performance.Strs.TryGetValue("effect_on", out var value) && performance.Nums.TryGetValue("effect_on_level", out var value2))
			{
				yield return new Pair<string, int>(value, (int)value2);
			}
		}
	}
