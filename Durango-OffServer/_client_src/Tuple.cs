...
public sealed class Tuple<T1, T2>
{
	...
	{
		return (391 + ((item1 != null) ? item1.GetHashCode() : 0)) * 23 + ((item2 != null) ? item2.GetHashCode() : 0);
	}
...
public sealed class Tuple<T1, T2, T3>
{
	...
	public override int GetHashCode()
	{
		return ((391 + ((item1 != null) ? item1.GetHashCode() : 0)) * 23 + ((item2 != null) ? item2.GetHashCode() : 0)) * 23 + ((item3 != null) ? item3.GetHashCode() : 0);
	}
...
public sealed class Tuple<T1, T2, T3, T4>
{
	...
	public override int GetHashCode()
	{
		return (((391 + ((item1 != null) ? item1.GetHashCode() : 0)) * 23 + ((item2 != null) ? item2.GetHashCode() : 0)) * 23 + ((item3 != null) ? item3.GetHashCode() : 0)) * 23 + ((item4 != null) ? item4.GetHashCode() : 0);
	}
