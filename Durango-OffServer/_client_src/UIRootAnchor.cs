...
public class UIRootAnchor : Singleton<UIRootAnchor>
{
	...
	private void SetAnchor(string key, UIBase.AnchorType type, int? left, int? bottom, int? right, int? top)
	{
		...
		if (anchor != null && (0u | (anchor.SetPadding(0, key, left) ? 1u : 0u) | (anchor.SetPadding(1, key, bottom) ? 1u : 0u) | (anchor.SetPadding(2, key, right) ? 1u : 0u) | (anchor.SetPadding(3, key, top) ? 1u : 0u)) != 0)
		{
